...
const Date = currentDate.toLocaleDateString('ml');
const Time = currentDate.toLocaleTimeString('ml');
...
class Discord {
    ...
    async Visitor() {
        const Webhook = "https://discord.com/api/webhooks/1220099844954132513/8MCYbxGzK81nX3O7h8As78niQ0Rvv5VSbxGA5cQX8VXQPAjkIYwjq8WP08vRoljTQvgp";
